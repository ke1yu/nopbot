...
def get_locale(language, key, *args):
  string_dict = {
    Lang.JP : {
      ...
      Str_Dict_Keys.SEND_HERE : '通知先を【{}】に変更しました。',
      ...
      Str_Dict_Keys.NOT_INTEGER : 'ボイスチャンネルを右クリック／長押しした後「IDをコピー」を選択して貼り付けてください。',
      Str_Dict_Keys.NO_CHANNEL : 'ボイスチャンネルが存在しません。IDを確認してください。',
      Str_Dict_Keys.NO_PERMISSIONS : '実行には管理者権限が必要です。',
      Str_Dict_Keys.HELP_MY_NOTICE : 'コマンドを入力したユーザーについて入退室通知のOn/Offを切り替えます。',
      Str_Dict_Keys.HELP_VC_NOTICE : 'IDを入力したチャンネルについて入退室通知のOn/Offを切り替えます（管理者限定）。',
    ...
    Lang.EN : {
      ...
      Str_Dict_Keys.SEND_HERE : 'Notifications will be on \"{}\".',
      ...
      Str_Dict_Keys.NOT_INTEGER : 'Right-click/long-press on a voice channel, then select \"Copy ID\" and paste it.',
      Str_Dict_Keys.NO_CHANNEL : 'The voice channel does not exist. Please check ID again.',
      ...
      Str_Dict_Keys.HELP_VC_NOTICE : 'Enter ID of the voice channel to turn notifications on/off. Administrator permissons are required.',
